...
# MONKEYPATCHES:
#
# 1. Added table_info = table_info.replace("\n)", ",\n	way GEOMETRY\n)") in site-packages/langchain_community/utilities/sql_database.py
# because for some reason the geometry column is not being listed by sqlalchemy
#
# 2. Added markdown backtick fix to site-packages/langchain_community/utilities/sql_database.py
